...
CREATE TABLE  [world] (
  [id] INT NOT NULL IDENTITY (1, 1) PRIMARY KEY NONCLUSTERED HASH WITH (BUCKET_COUNT=70000),
...
CREATE TABLE  [fortune] (
  [id] INT NOT NULL IDENTITY (1, 1) PRIMARY KEY NONCLUSTERED HASH WITH (BUCKET_COUNT=100),
