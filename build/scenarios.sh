...
jobs=(
  ...
  # Mono
  "-n PlaintextPlatform-Mono --webHost KestrelSockets $trend $plaintextPlatformJobs -i 3"
  "-n Plaintext-Mono --webHost KestrelSockets $trend $plaintextJobs -i 3"
  "-n PlaintextNonPipelined-Mono --webHost KestrelSockets $trend $plaintextJobs"
  "-n JsonPlatform-Mono --webHost KestrelSockets $trend $jsonPlatformJobs"
  "-n Json-Mono --webHost KestrelSockets $trend $jsonJobs"
  "-n Plaintext-Mono -m https --webHost KestrelSockets $trend $plaintextJobs"
  "-n DbFortunesRaw-Mono --webHost KestrelSockets $trend $htmlJobs --database PostgreSql"
  "-n PlaintextPlatform-Mono-LLVM-JIT --webHost KestrelSockets $trend $plaintextPlatformJobs -i 3"
  "-n Plaintext-Mono-LLVM-JIT --webHost KestrelSockets $trend $plaintextJobs -i 3"
  "-n PlaintextNonPipelined-Mono-LLVM-JIT --webHost KestrelSockets $trend $plaintextJobs"
