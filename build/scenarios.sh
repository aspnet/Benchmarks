...
jobs=(
  ...
  "-n Plaintext --webHost KestrelSockets $baseline $plaintextLibuvThreadCount $plaintextJobs"
  "-n Plaintext --webHost KestrelSockets $trend $plaintextJobs" 
  "-n PlaintextNonPipelined --webHost KestrelSockets $baseline $plaintextLibuvThreadCount $plaintextJobs"
  ...
  # BasicApi
  "--scenario BasicApi.GetUsingRouteValueWithoutToken $trend $basicApiJobs"
  "--scenario BasicApi.GetUsingRouteValueWithoutAuthorization $trend $basicApiJobs"
  ...
  "--scenario BasicViews.PostWithoutToken $trend $basicViewsJobs"
  "--scenario BasicViews.PostIgnoringToken $trend $basicViewsJobs"
