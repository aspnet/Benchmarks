...
signalRJobs="-j https://raw.githubusercontent.com/aspnet/AspNetCore/master/src/SignalR/benchmarkapps/BenchmarkServer/signalr.json -t SignalR -r aspnetcore --projectFile src/SignalR/benchmarkapps/BenchmarkServer/BenchmarkServer.csproj"
