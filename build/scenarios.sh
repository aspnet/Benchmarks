...
jobs=(
  ...
  # GRPC ASP.NET Core
  "-n GrpcUnary-h2load --webHost KestrelSockets $trend $grpcManagedJobs --connections 128 --warmup 5 -m h2c"
  "-n GrpcUnary-h2load --webHost KestrelSockets $trend $grpcManagedJobs --connections 128 --warmup 5 -m h2"
  "-n GrpcUnary-GrpcCore --webHost KestrelSockets $trend $grpcManagedJobs --connections 128 --warmup 5 -m h2c"
  "-n GrpcUnary-GrpcNetClient --webHost KestrelSockets $trend $grpcManagedJobs --connections 128 --warmup 5 -m h2c"
  "-n GrpcUnary-GrpcNetClient --webHost KestrelSockets $trend $grpcManagedJobs --connections 128 --warmup 5 -m h2"
  ...
  "-n GrpcUnary-GrpcCore --webHost CCore $trend $grpcNativeJobs --connections 128 --warmup 5 -m h2c"
