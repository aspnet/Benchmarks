...
efcoreJobs="-r EntityFrameworkCore@release/3.0 --description Benchmarks --arg --perflab --arg \"--job short\" --no-global-json --server-timeout 00:45:00 -t EFCoreBenchmarks --sdk 3.0.100-preview8-013656"
