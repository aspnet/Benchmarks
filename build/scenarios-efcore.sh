...
efcoreJobs="-r EntityFrameworkCore@master --description Benchmarks --arg --perflab --server-timeout 00:45:00 -t EFCoreBenchmarks --aspnetcoreversion 3.1 --runtimeversion 3.1 --sdk 3.1.102"
