...
Options:
  ...
  --[JOB].useMonoRuntime <jit|llvm-jit>                                    Use a specific mono runtime instead of the dotnet core runtime.
  ...
  --[JOB].counterProviders <provider>                                      The name of a performance counter provider from which to collect. e.g., System.Runtime (default if none is set), Microsoft-AspNetCore-Server-Kestrel, Npgsql
